...
I'm a **Backend Engineer** focused on building systems that are **correct before they are clever**. My work centers on **Spring Boot** with deliberate emphasis on **Modular Monolith**, **Event-Driven Architecture**, and **Clean Architecture** — choosing the right abstraction for the problem, not the most fashionable one.
...
> _"Design for today's complexity, not tomorrow's imagined scale."_
...
| **Test-Driven Development** | Tests are the primary design feedback loop. Red → Green → Refactor is not a testing strategy, it is a design strategy                                                                                   |
